    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* ✅ Scrollable wrapper — fills the screen and scrolls on mobile */}
                ...
                <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800">
                  ...
                  <div className="p-6 md:p-8">
                    ...
                    <div className="relative mb-6 rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
                      {/* ✅ Responsive aspect ratio: taller on mobile for portrait screens */}
                      <div
                    ...
                    <div className="mb-6">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        {project.screens.length > 1 && (
                          <div className="text-sm text-slate-500 dark:text-slate-400 font-medium shrink-0 ml-2">
                    ...
                    {project.tags.length > 0 && (
                      <div className="mb-6 flex flex-wrap gap-2">
                        {project.tags.map((tag) => (
                          <span
                            key={tag}
                            className="px-3 py-1 rounded-full text-xs md:text-sm bg-blue-50 dark:bg-blue-950/50 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800"
                          >
                            {tag}
                          </span>
                        ))}
